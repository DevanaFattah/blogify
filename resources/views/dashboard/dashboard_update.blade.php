    ...
    <div class="col-md-6">
        ...
        @csrf
            ...
            <div class="mb-3">
                ...
                <input type="text" name="slug" value="{{ $post->slug }}" class="form-control" id="exampleFormControlInput1" placeholder="">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                <button type="submit" class="btn btn-primary mb-3">Edit Now</button>
            </div>
        </form>
    </div>
  </div>
